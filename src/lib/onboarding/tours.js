  ...
  campaigns: {
    ...
    steps: [
      ...
      },
      {
        id: "filters",
        title: "Filtros",
        body: "Todas · Hoje (só agenda do dia) · Arquivadas. Use Hoje quando quiser ver só o que cabe na data.",
  ...
  champions: {
    ...
    steps: [
      ...
      },
      {
        ...
        body: "Ciclo do Tobias: Continuar → executar → Timer quando quiser → Campanhas para ajustar → Perfil e Atividade para se ver. Bom foco.",
        ctaHref: "/",
